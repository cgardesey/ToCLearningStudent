...
import static com.prepeez.toclearningstudent.ChatActivity.DEFAULT_MSG_LENGTH;
import static com.prepeez.toclearningstudent.ChatActivity.JSON_KEY;
import static com.prepeez.toclearningstudent.ChatActivity.MSG_LENGTH_KEY;
import static com.prepeez.toclearningstudent.ChatActivity.PREF_JSON_KEY;
import static com.prepeez.toclearningstudent.ChatActivity.PREF_MSG_LENGTH_KEY;
...
//        Toast.makeText(this, PreferenceManager.getDefaultSharedPreferences(this).getString(PREF_JSON_KEY, DEFAULT_JSON), Toast.LENGTH_SHORT).show();
            ...
            Log.e("Bye_to_windows", e.toString());
        }
    }
