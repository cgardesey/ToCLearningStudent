package com.prepeez.toclearningstudent.adapter.viewHolder;
...
public class MyCourselistAdapter extends RecyclerView.Adapter<MyCourselistAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_my_course, parent, false);
