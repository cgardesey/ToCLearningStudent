package com.prepeez.toclearningstudent.other;
...
import com.prepeez.toclearningstudent.adapter.ViewPagerCarouselAdapter;
...
public class ViewPagerCarouselView extends RelativeLayout {
    private android.support.v4.app.FragmentManager fragmentManager;                // FragmentManager for managing the fragments withing the ViewPager
     ...
     */
    public void setData(android.support.v4.app.FragmentManager fragmentManager, int [] imageResourceIds, long carouselSlideInterval) {
    ...
    private void initCarouselSlide() {
        ...
        try {
            ...
            Log.d("ViewPagerCarouselView", e.getMessage());
        }
    }
